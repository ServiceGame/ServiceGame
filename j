...
local function BBBYRC_fake_script() -- close.closeapp 
	...
	local gui = button.Parent.Parent -- Ïðåäïîëàãàåòñÿ, ÷òî êíîïêà âíóòðè Frame, à Frame âíóòðè ScreenGui
...
local function GFRMEVT_fake_script() -- god.godmode 
	...
	-- **Ôóíêöèÿ àêòèâàöèè GodMode**
	local function toggleGodMode()
		active = not active
	
		if active then
			-- Óñòàíàâëèâàåì áåñêîíå÷íîå çäîðîâüå
			humanoid.MaxHealth = math.huge
			humanoid.Health = math.huge
	
			-- Ñîçäàåì îáúåêò çàùèòû îò óðîíà (åñëè îí åùå íå ñîçäàí)
		...
		-- Èçìåíåíèå öâåòà êíîïêè
		button.TextColor3 = active and Color3.fromRGB(50, 255, 50) or Color3.fromRGB(255, 50, 50) -- Çåëåíûé åñëè âêëþ÷åíî, êðàñíûé åñëè âûêëþ÷åíî
		button.BackgroundColor3 = active and Color3.fromRGB(60, 60, 60) or Color3.fromRGB(40, 40, 40) -- Íåáîëüøîå çàòåìíåíèå ïðè àêòèâàöèè
	end
	
	-- **Îáðàáîò÷èê íàæàòèÿ êíîïêè**
