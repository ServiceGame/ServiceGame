...
function UI.Initialize()
    ...
    local Windows = NEVERLOSE:AddWindow("ServiceGame","ServiceGame - Fisch - V0.1.8 - discord.gg/gtQ54c43G3")
...
Convenience:AddButton("Protect Identity", function()
    ...
    getgenv().name = "discord.gg/gtQ54c43G3 on top"
...
task.delay(5, function()
    ...
    CreditsSection:AddLabel("Fisch ServiceGame Script by Wibu")
    CreditsSection:AddButton(
        "Copy Discord Link",
        function()
            setclipboard("discord.gg/gtQ54c43G3")
...
--bro bdokkx is a nexam developer / Ronix Arsenal V1.0 - discord.gg/gtQ54c43G3
--User
